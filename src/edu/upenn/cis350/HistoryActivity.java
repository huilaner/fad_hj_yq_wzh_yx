...
public class HistoryActivity extends Activity{
	...
	class HistoryAdapter extends BaseAdapter{
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			final String providerString = InternetHelper.httpGetRequest(uri);			
			try{
				JSONObject fakeJson = new JSONObject(providerString);
				String actualJsonString = fakeJson.getString("provider");
				JSONObject json = new JSONObject(actualJsonString);
				Provider provider = ProviderHelper.createProviderFromJson(json);
